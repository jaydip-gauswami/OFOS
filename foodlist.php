...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/slide0002.jpg" style="width:100%; height:67%">
...
?>
<div class="col-md-3" style="margin:2.5rem 0rem;">

<form method="post" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
<div class="mypanel" style=" width:26rem;   height:45rem; display:flex; flex-direction:column; align-item:center; justify-content:center; padding:6px 0px; position:reletive; " align="center">
<img style="width:100%;height:38%;" src="<?php echo $row["images_path"]; ?>" class="img-responsive">
...
<div style="position:reletive; bottom:0;">
